...
def test_unknown_work_type_rejected(env):
    ...
    with pytest.raises(ValueError):
        store.create_version(conn, "ws", "not_a_type", "# x", [], model="m")
